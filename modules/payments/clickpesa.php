...
$api_key = CLICKPESA_API_KEY;
$secret = CLICKPESA_SECRET;
...
$payment_data = array(
    ...
    'order_id' => $order_id,
    'currency' => 'TZS',
    'callback_url' => SITE_URL . '/modules/payments/clickpesa_callback.php'
);

// Make API call to ClickPesa
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://api.clickpesa.com/v1/payments');
